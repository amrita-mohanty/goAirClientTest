...
public interface AdminServices extends java.rmi.Remote {
    ...
    public goair.model.employee.Employee[] getEmpployeesForFlight(java.util.Calendar dateOfFlying, int flightId) throws java.rmi.RemoteException;
    ...
    public goair.model.customer.Customer[] getCustomersForFlight(java.util.Calendar dateOfFlying, int flightId) throws java.rmi.RemoteException;
}
